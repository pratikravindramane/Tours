    ...
    <div className="container mt-5 pt-3" style={{ minHeight: "52vh" }}>
      <div className="row">
        <div className="col-md-6">
          <h1 className="mb-2">Welcome to Tour Management System</h1>
          <p className="fs-6">
            ...
            institutions. At Tavelus, we understand the
            importance of bridging theoretical knowledge with real-world
            experiences, and our meticulously crafted industrial visit programs
            aim to do just that.
          </p>
